...
func Test(t *testing.T) {
	...
	_, err := ks.Validate(context.Background(), "eyJhbGciOiJSUzI1NiIsImtpZCI6IkNFaFRmRmQxdW53IiwidHlwIjoiSldUIn0.eyJhdWQiOlsiaHctZGV2Il0sImV4cCI6MTYyMjg4NTE1MCwiaWF0IjoxNjIwMjkzMTUwLCJpc3MiOiJvY3RvaGVsbS50ZWNoIiwianRpIjoiMTQyNDU5ODcyMjk3MDkxMzc3Iiwic3ViIjoiS1VCRV9BR0VOVCJ9.S--kdlu5tFAMMfL1Ofmnfzlcv8D2-zK9VWkpVyr6bgnA8uPNlalRRLvzISIomTDpybuNEeCSui_p6CrOgEBzmaGgVk-EnIUl300V5FUDIPw2mglRJC3ZGs9jMlzqd6qCGDYM67N-7x1PK46Vj6aqMyZlevwXD7xhUvuYGNjSngA")
	spew.Dump(err)
